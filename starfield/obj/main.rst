...
Hexadecimal [16-Bits]
                             ...
                             10 
                             11 
                             12 ;; Entities to create
   40B7                      13 Entity_t init_e0 e_type_star, 79, 1,   -3, 0xFF ; type, x, y, vx, color
   0000                       1 init_e0::
   0000                       2    Unknown_Entity_t e_type_star, 79, 1, -3, 0xFF
   40B7 01                    1    .db   e_type_star
   40B8 4F                    2    .db   79
   40B9 01                    3    .db   1
   40BA FD                    4    .db   -3
   40BB FF                    5    .db   0xFF
   40BC                      14 Entity_t init_e1 e_type_star, 79, 9,  -1, 0xFF ; type, x, y, vx, color
   0005                       1 init_e1::
   0005                       2    Unknown_Entity_t e_type_star, 79, 9, -1, 0xFF
   40BC 01                    1    .db   e_type_star
   40BD 4F                    2    .db   79
   40BE 09                    3    .db   9
   40BF FF                    4    .db   -1
   40C0 FF                    5    .db   0xFF
   40C1                      15 Entity_t init_e2 e_type_star, 79, 15,  -3, 0xFF ; type, x, y, vx, color
   000A                       1 init_e2::
   000A                       2    Unknown_Entity_t e_type_star, 79, 15, -3, 0xFF
   40C1 01                    1    .db   e_type_star
   40C2 4F                    2    .db   79
   40C3 0F                    3    .db   15
   40C4 FD                    4    .db   -3
   40C5 FF                    5    .db   0xFF
   40C6                      16 Entity_t init_e3 e_type_star, 79, 30, -1, 0xFF ; type, x, y, vx, color
   000F                       1 init_e3::
   000F                       2    Unknown_Entity_t e_type_star, 79, 30, -1, 0xFF
   40C6 01                    1    .db   e_type_star
   40C7 4F                    2    .db   79
   40C8 1E                    3    .db   30
   40C9 FF                    4    .db   -1
   40CA FF                    5    .db   0xFF
   40CB                      17 Entity_t init_e4 e_type_star, 79, 55, -2, 0xFF ; type, x, y, vx, color
   0014                       1 init_e4::
   0014                       2    Unknown_Entity_t e_type_star, 79, 55, -2, 0xFF
   40CB 01                    1    .db   e_type_star
   40CC 4F                    2    .db   79
   40CD 37                    3    .db   55
   40CE FE                    4    .db   -2
   40CF FF                    5    .db   0xFF
   40D0                      18 Entity_t init_e5 e_type_star, 79, 70, -1, 0xFF ; type, x, y, vx, color
   0019                       1 init_e5::
   0019                       2    Unknown_Entity_t e_type_star, 79, 70, -1, 0xFF
   40D0 01                    1    .db   e_type_star
   40D1 4F                    2    .db   79
   40D2 46                    3    .db   70
   40D3 FF                    4    .db   -1
   40D4 FF                    5    .db   0xFF
...
Hexadecimal [16-Bits]
   ...
   40D5                      19 Entity_t init_e6 e_type_star, 79, 75, -3, 0xFF ; type, x, y, vx, color
   001E                       1 init_e6::
   001E                       2    Unknown_Entity_t e_type_star, 79, 75, -3, 0xFF
   40D5 01                    1    .db   e_type_star
   40D6 4F                    2    .db   79
   40D7 4B                    3    .db   75
   40D8 FD                    4    .db   -3
   40D9 FF                    5    .db   0xFF
   40DA                      20 Entity_t init_e7 e_type_star, 79, 100, -1, 0xFF ; type, x, y, vx, color
   0023                       1 init_e7::
   0023                       2    Unknown_Entity_t e_type_star, 79, 100, -1, 0xFF
   40DA 01                    1    .db   e_type_star
   40DB 4F                    2    .db   79
   40DC 64                    3    .db   100
   40DD FF                    4    .db   -1
   40DE FF                    5    .db   0xFF
   40DF                      21 Entity_t init_e8 e_type_star, 79, 120, -2, 0xFF ; type, x, y, vx, color
   0028                       1 init_e8::
   0028                       2    Unknown_Entity_t e_type_star, 79, 120, -2, 0xFF
   40DF 01                    1    .db   e_type_star
   40E0 4F                    2    .db   79
   40E1 78                    3    .db   120
   40E2 FE                    4    .db   -2
   40E3 FF                    5    .db   0xFF
   40E4                      22 Entity_t init_e9 e_type_star, 79, 125, -3, 0xFF ; type, x, y, vx, color
   002D                       1 init_e9::
   002D                       2    Unknown_Entity_t e_type_star, 79, 125, -3, 0xFF
   40E4 01                    1    .db   e_type_star
   40E5 4F                    2    .db   79
   40E6 7D                    3    .db   125
   40E7 FD                    4    .db   -3
   40E8 FF                    5    .db   0xFF
   40E9                      23 Entity_t init_e10 e_type_star, 79, 150, -2, 0xFF ; type, x, y, vx, color
   0032                       1 init_e10::
   0032                       2    Unknown_Entity_t e_type_star, 79, 150, -2, 0xFF
   40E9 01                    1    .db   e_type_star
   40EA 4F                    2    .db   79
   40EB 96                    3    .db   150
   40EC FE                    4    .db   -2
   40ED FF                    5    .db   0xFF
   40EE                      24 Entity_t init_e11 e_type_star, 79, 155, -1, 0xFF ; type, x, y, vx, color
   0037                       1 init_e11::
   0037                       2    Unknown_Entity_t e_type_star, 79, 155, -1, 0xFF
   40EE 01                    1    .db   e_type_star
   40EF 4F                    2    .db   79
   40F0 9B                    3    .db   155
   40F1 FF                    4    .db   -1
   40F2 FF                    5    .db   0xFF
   40F3                      25 Entity_t init_e12 e_type_star, 79, 130, -3, 0xFF ; type, x, y, vx, color
   003C                       1 init_e12::
   003C                       2    Unknown_Entity_t e_type_star, 79, 130, -3, 0xFF
   40F3 01                    1    .db   e_type_star
   40F4 4F                    2    .db   79
   40F5 82                    3    .db   130
   40F6 FD                    4    .db   -3
...
Hexadecimal [16-Bits]
   ...
   40F7 FF                    5    .db   0xFF
   40F8                      26 Entity_t init_e13 e_type_star, 79, 151, -2, 0xFF ; type, x, y, vx, color
   0041                       1 init_e13::
   0041                       2    Unknown_Entity_t e_type_star, 79, 151, -2, 0xFF
   40F8 01                    1    .db   e_type_star
   40F9 4F                    2    .db   79
   40FA 97                    3    .db   151
   40FB FE                    4    .db   -2
   40FC FF                    5    .db   0xFF
   40FD                      27 Entity_t init_e14 e_type_star, 79, 170, -1, 0xFF ; type, x, y, vx, color
   0046                       1 init_e14::
   0046                       2    Unknown_Entity_t e_type_star, 79, 170, -1, 0xFF
   40FD 01                    1    .db   e_type_star
   40FE 4F                    2    .db   79
   40FF AA                    3    .db   170
   4100 FF                    4    .db   -1
   4101 FF                    5    .db   0xFF
   ...
   4102 CD DC 41      [17]   33    call cpct_disableFirmware_asm
                             34 
                             35    ;; Each byte has 2 pixels
   4105 0E 00         [ 7]   36    ld    c, #0
   4107 CD C7 41      [17]   37    call cpct_setVideoMode_asm
                             38 
                             39   ; ld    h, #30
                             40   ; ld    l, #30
                             41   ; ld    a, #30
                             42   ; call cpct_setBorder_asm
                             43 
                             44   ; ld    l, #0
                             45   ; ld    h, #31
                             46   ; call cpct_setPALColour_asm
                             47 
                             48 
   410A 21 B7 40      [10]   49    ld    hl, #init_e0
   410D CD 50 40      [17]   50    call manager_entity_create
   4110 21 BC 40      [10]   51    ld    hl, #init_e1
   4113 CD 50 40      [17]   52    call manager_entity_create
   4116 21 C1 40      [10]   53    ld    hl, #init_e2
   4119 CD 50 40      [17]   54    call manager_entity_create
   411C 21 C6 40      [10]   55    ld    hl, #init_e3
   411F CD 50 40      [17]   56    call manager_entity_create
   4122 21 CB 40      [10]   57    ld    hl, #init_e4
   4125 CD 50 40      [17]   58    call manager_entity_create
   4128 21 D0 40      [10]   59    ld    hl, #init_e5
   412B CD 50 40      [17]   60    call manager_entity_create
   412E 21 D5 40      [10]   61    ld    hl, #init_e6
   4131 CD 50 40      [17]   62    call manager_entity_create
   4134 21 DA 40      [10]   63    ld    hl, #init_e7
   4137 CD 50 40      [17]   64    call manager_entity_create
   413A 21 DF 40      [10]   65    ld    hl, #init_e8
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 60.
Hexadecimal [16-Bits]



   413D CD 50 40      [17]   66    call manager_entity_create
   4140 21 E4 40      [10]   67    ld    hl, #init_e9
   4143 CD 50 40      [17]   68    call manager_entity_create
   4146 21 E9 40      [10]   69    ld    hl, #init_e10
   4149 CD 50 40      [17]   70    call manager_entity_create
   414C 21 EE 40      [10]   71    ld    hl, #init_e11
   414F CD 50 40      [17]   72    call manager_entity_create
   4152 21 F3 40      [10]   73    ld    hl, #init_e12
   4155 CD 50 40      [17]   74    call manager_entity_create
   4158 21 F8 40      [10]   75    ld    hl, #init_e13
   415B CD 50 40      [17]   76    call manager_entity_create
   415E 21 FD 40      [10]   77    ld    hl, #init_e14
   4161 CD 50 40      [17]   78    call manager_entity_create
                             79   
                             80 
                             81    ;; Loop forever
   4164                      82 loop:
                             83 
   4164 CD 98 41      [17]   84    call system_physics_update
   4167 CD D4 41      [17]   85    call cpct_waitVSYNC_asm
                             86 ;  call wait_go_slow
   416A CD B7 41      [17]   87    call system_render_update
                             88 
   416D 18 F5         [12]   89    jr    loop
                             90 
                             91 
                             92 
                             93 
   416F                      94 wait_go_slow::
                             95 
   416F 3E 15         [ 7]   96    ld    a, #0x15
                             97 
   4171                      98 _wtloop:
   4171 76            [ 4]   99    halt
                            100 
   4172 3D            [ 4]  101    dec   a
   4173 20 FC         [12]  102    jr   nz, _wtloop
                            103 
   4175 CD D4 41      [17]  104    call cpct_waitVSYNC_asm
                            105 
   4178 C9            [10]  106    ret
